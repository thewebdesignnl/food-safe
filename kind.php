                                        ...
                                        <div>
                                            <table class="table all-package theme-table" id="table_id">
                                                ...
                                                <tbody>
                                                 <?php
                                                $i=0;
                                                $statement = $pdo->prepare("SELECT * FROM kinds ORDER BY id DESC");
                                                $statement->execute();
                                                ...
                                                foreach ($result as $row) {	?>   
                                                    <tr>												
                                                      ...
                                                      <td>
                                                        <ul>
                                     <li><a href="edit.php?id=<?php echo $row['id']; ?>&type=3"><i class="ri-pencil-line"></i></a> </li>
                                     <li><a href="javascript:void(0)" data-bs-toggle="modal"  data-bs-target="#exampleModalToggle"  data-id="<?php echo $row['id']; ?>" data-type="3"  class="delete-btn"><i class="ri-delete-bin-line"></i> </a> </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
